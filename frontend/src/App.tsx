...
import { SellersList, SellersCreate, SellersEdit } from './resources/Sellers';
...
import SellersIcon from '@mui/icons-material/Storefront';
// SUPERTOKENS
...
const App = () => (
  <SuperTokensWrapper>
    <BrowserRouter basename="/ae087eded">
      <Admin
        authProvider={
      ...
      >
        ...
        <Resource
          ...
          create={NotesCreate}
          edit={NotesEdit}
          recordRepresentation="Denomination"
          icon={NotesIcon}
        />
        <Resource
          name="Sellers"
